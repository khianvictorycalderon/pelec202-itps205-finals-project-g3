      ...
      <nav className="fixed top-0 left-0 w-full z-50 bg-sky-900 px-4 py-3 shadow-md">
        ...
        {isMobileMenuOpen && (
          <div className="md:hidden mt-3 pb-2 flex flex-col items-center space-y-2">
            ...
            <Link
              to="/"
              className="w-full text-center text-cyan-300 hover:bg-cyan-600 hover:text-white px-4 py-2 rounded-md font-medium transition-colors"
            ...
            <Link
              to="/browse"
              className="w-full text-center text-cyan-300 hover:bg-cyan-600 hover:text-white px-4 py-2 rounded-md font-medium transition-colors flex items-center justify-center gap-2"
              onClick={() => setIsMobileMenuOpen(false)}
            >
              <svg
